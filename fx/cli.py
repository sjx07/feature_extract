...
def main(argv=None) -> int:
    ...
    if a.cmd == "library":
        ...
        status = run_library(store, ws, Client(store), jid, a.corpus, a.kind, a.sub, model=model, workers=a.workers, version=a.version, effort=a.effort, echo=lambda line: print("  " + line, flush=True))
