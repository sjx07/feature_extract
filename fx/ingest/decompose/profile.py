...
`ask` is any callable prompt -> reply text; the stage wires it to fx.core.llm.Client.
"""
...
from fx.ingest.decompose import prompts as P
from fx.ingest.decompose.contract import Component, Tree, parse_components
from fx.ingest.decompose.locate import nonspace, normalize, validate_components
