...
fx.ingest.loop on the wording level (fx.ingest.induce.level); this package adds what only the wording level has, collapse
...
from fx.ingest.induce.codebook import BATCH, COLDSTART_MODEL, KINDS, MIN_SUPPORT, anchors, flags, groups, latest, leftovers, members, nodes, status
from fx.ingest.induce.coldstart import coldstart
from fx.ingest.induce.collapse import collapse, realizations
...
from fx.ingest.induce.preview import preview  # noqa: E402
