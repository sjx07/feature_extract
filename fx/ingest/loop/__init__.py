"""The library loop, written once against a Level (fx.ingest.loop.level), one module per step:
...
from fx.ingest.loop.join import indistinct_pairs, join, render_pairs
from fx.ingest.loop.judge import judge, reopen
from fx.ingest.loop.level import Level
from fx.ingest.loop.name import candidates, name, render_proposals
from fx.ingest.loop.round import run_round
from fx.ingest.loop.state import anchors, embed, members, node_vectors, nodes, open_units, tree, vectors
